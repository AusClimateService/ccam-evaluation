...
#PBS -P xv83
#PBS -q normal
#PBS -l storage=scratch/du7+gdata/du7+gdata/access+gdata/hh5+gdata/r87+gdata/ub4+gdata/rr3+gdata/al33+gdata/ma05+gdata/dp9+gdata/rr8+scratch/e53+gdata/wr45+gdata/rt52+gdata/wr45+gdata/hd50+gdata/tp28+scratch/hd50+scratch/tp28+gdata/xv83+gdata/ia39+scratch/xv83+gdata/oi10
...
IN_VERSION=v1
IN_ROOT_DIR=/g/data/xv83/bxn599/ACS/data/noresm2-mm
DOMAIN=GLOBAL-gn
OUT_ROOT_DIR=/g/data/xv83/$USER/ACS/icclim_indices
OUT_VERSION=v1
#SLICE_MODE=month
TIME_PERIOD="1970-01-01 2014-12-31"
...
# bivariate
  if [ "$count" == "2" ]; then
	...
	if [ $? -ne 0 ]; then
		...
		touch fail.noresm2-mm.${index}
	else
		touch success.noresm2-mm.${index}
	fi
done
done