...
GCM_MODEL_NAME=CNRM-CERFACS-CNRM-ESM2-1
EXPERIMENT_NAME=ssp370
ENSEMBLE_MEMBER=r1i1p1f2
#IN_ROOT_DIR=/g/data/xv83/mxt599/ccam_era5_evaluation_aus-10i_12km/drs_cordex/CORDEX/output/AUS-10i/CSIRO/ECMWF-ERA5/evaluation/r1i1p1f2/CSIRO-CCAM-2203/v1/day
IN_ROOT_DIR=/g/data/xv83/mxt599/ccam_cnrm-esm2-1_ssp370_aus-10i_12km/drs_cordex/CORDEX/output/AUS-10i/CSIRO/CNRM-CERFACS-CNRM-ESM2-1/ssp370/r1i1p1f2/CSIRO-CCAM-2203/v1/day
DOMAIN=AUS-10
...
# bivariate
  if [ "$count" == "2" ]; then
	...
	if [ $? -ne 0 ]; then
		...
		touch fail.ccam.cnrm-esm2-1.${index}
	else
		touch success.ccam.cnrm-esm2-1.${index}
	fi
done
done