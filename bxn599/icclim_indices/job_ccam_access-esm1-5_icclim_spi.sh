...
IN_ROOT_DIR=/g/data/xv83/mxt599/ccam_access-esm1-5_historical_aus-10i_12km/drs_cordex/CORDEX-CMIP6/output/AUS-10i/CSIRO/CSIRO-ACCESS-ESM1-5/historical/r6i1p1f1/CSIRO-CCAM-2203/v1/day
DOMAIN=AUS-10
...
# bivariate
  ...
  if [ $? -ne 0 ]; then
    ...
    touch fail.ccam.access-esm1-5.${index}
  else
    touch success.ccam.access-esm1-5.${index}
  fi
done
done