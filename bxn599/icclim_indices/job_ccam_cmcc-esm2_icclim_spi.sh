...
IN_ROOT_DIR=/g/data/xv83/mxt599/ccam_cmcc-esm2_historical_aus-10i_12km/drs_cordex/CORDEX-CMIP6/output/AUS-10i/CSIRO/CMCC-CMCC-ESM2/historical/r1i1p1f1/CSIRO-CCAM-2203/v1/day
DOMAIN=AUS-10
...
# bivariate
  ...
  if [ $? -ne 0 ]; then
    ...
    touch fail.ccam.cmcc-esm2.${index}
  else
    touch success.ccam.cmcc-esm2.${index}
  fi
done
done