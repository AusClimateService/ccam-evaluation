...
IN_ROOT_DIR=/g/data/ia39/australian-climate-service/test-data/CORDEX-CMIP6/output/AUS-15/BOM/NCAR-CESM2/historical/r11i1p1f1/BOM-BARPA-R/v1/day
DOMAIN=AUS-15
...
# bivariate
  ...
  if [ $? -ne 0 ]; then
    ...
    touch fail.barpa.cesm2.${index}
  else
    touch success.barpa.cesm2.${index}
  fi
done
done