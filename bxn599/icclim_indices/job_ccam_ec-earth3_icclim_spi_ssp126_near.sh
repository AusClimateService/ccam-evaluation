...
IN_ROOT_DIR=/g/data/xv83/mxt599/ccam_ec-earth3_ssp126_aus-10i_12km/drs_cordex/CORDEX/output/AUS-10i/CSIRO/EC-Earth-Consortium-EC-Earth3/ssp126/r1i1p1f1/CSIRO-CCAM-2203/v1/day
DOMAIN=AUS-10
...
# bivariate
  ...
  if [ $? -ne 0 ]; then
    ...
    touch fail.ccam.ec-earth3.${index}
  else
    touch success.ccam.ec-earth3.${index}
  fi
done
done