...
RCM_MODEL_NAME=none
GCM_MODEL_NAME=MPI-M-MPI-ESM1-2-HR
EXPERIMENT_NAME=ssp370
ENSEMBLE_MEMBER=r1i1p1f1
IN_ROOT_DIR=/g/data/xv83/users/bxn599/ACS/data/mpi-esm1-2-hr/ssp370
DOMAIN=GLOBAL-gn
...
# bivariate
  if [ "$count" == "2" ]; then
	...
	if [ $? -ne 0 ]; then
		...
		touch fail.mpi-esm1-2-hr.ssp370.near.${index}
	else
		touch success.mpi-esm1-2-hr.ssp370.near.${index}
	fi
done
done