...
IN_ROOT_DIR=/g/data/ia39/australian-climate-service/test-data/CORDEX-CMIP6/output/AUS-15/BOM/ECMWF-ERA5/evaluation/r1i1p1f1/BOM-BARPA-R/v1/day
DOMAIN=AUS-15
OUT_ROOT_DIR=/g/data/xv83/users/$USER/ACS/icclim_indices
RCM_VERSION=v1
#SLICE_MODE=month
TIME_PERIOD="1979-01-01 2020-12-31"
