...
IN_ROOT_DIR=/g/data/ia39/australian-climate-service/release/CORDEX-CMIP6/output/AUS-15/BOM/EC-Earth-Consortium-EC-Earth3/ssp126/r1i1p1f1/BOM-BARPA-R/v1/day
DOMAIN=AUS-15
...
# bivariate
  ...
  if [ $? -ne 0 ]; then
    ...
    touch fail.barpa.ec-earth3.ssp126.${index}
  else
    touch success.barpa.ec-earth3.ssp126.${index}
  fi
done
done