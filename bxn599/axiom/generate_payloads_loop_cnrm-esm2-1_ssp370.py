...
payload = Payload(
  ...
  input_files='/g/data/xv83/mxt599/ccam_cnrm-esm2-1_ssp370_aus-10i_12km/cordex/*.nc',

  # Specify the output directory (DRS structure will be built from here).
  output_directory='/g/data/xv83/mxt599/ccam_cnrm-esm2-1_ssp370_aus-10i_12km/drs_cordex',
...
for freq in freql:
  ...
  for year in range(2015,2100): #include an extra year
    ...
    payload.to_json(f'/g/data/xv83/users/bxn599/ACS/axiom/ccam_cnrm-esm2-1_ssp370_aus-10i_12km/{freq}-payloads-{year}.json')
