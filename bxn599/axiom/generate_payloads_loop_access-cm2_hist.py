...
payload = Payload(
  ...
  input_files='/g/data/xv83/mxt599/ccam_access-cm2_historical_aus-10i_12km/cordex/*.nc',

  # Specify the output directory (DRS structure will be built from here).
  output_directory='/g/data/xv83/mxt599/ccam_access-cm2_historical_aus-10i_12km/drs_cordex',
