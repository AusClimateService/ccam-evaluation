...
convert = {'ua':'u','va':'v','omega':'w','ta':'t','zg':'z','hus':'q','psl':'msl','tas':'2t','pr':'tp','hur':'r'}
...
#        data = data*g
    ...
    data.rename(var)
    try:
        os.mkdir("/g/data/xv83/users/bxn599/ACS/ilamb/DATA/"+var)
        os.mkdir("/g/data/xv83/users/bxn599/ACS/ilamb/DATA/"+var+"/ERA5")
    except:
        1
    iris.save(data,"/g/data/xv83/users/bxn599/ACS/ilamb/DATA/{var}/ERA5/ERA5_{var}.nc".format(var=var),zlib=True,packing='i2')
