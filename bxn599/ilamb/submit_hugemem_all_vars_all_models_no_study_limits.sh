...
mpirun -n 48 ./ilamb-run --config all_vars_all_models.cfg --model_root $ILAMB_ROOT/MODELS/ --build_dir ./_build_all_vars_all_models --regions global australia wettropics rangelandsnorth monsoonalnortheast monsoonalnorthwest eastcoastsouth centralslopes murraybasin southernandsouthwesternflatlandswest southernandsouthwesternflatlandseast southernslopesvicnsweast southernslopesvicwest southernslopestaseast southernslopestaswest eastcoastnorth rangelandssouth MC
