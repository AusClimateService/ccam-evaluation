...
infiles=c("./data/tp_era5_19950101-20141231.nc","./data/mx2t_era5_19950101-20141231.nc","./data/mn2t_era5_19950101-20141231.nc")
#infiles="./era5_v4/pr_day_surf.ccam_25.km.1995-2014.nc"

# list of variable names according to above file(s)
vars=c(prec="tp",tmax="mx2t",tmin="mn2t")
#vars=c(prec="pr")
...
file.template="var_daily_climpact.era5_historical_NA_1995-2014.nc"
