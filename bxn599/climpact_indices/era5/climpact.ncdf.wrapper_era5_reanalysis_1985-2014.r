...
infiles=c("./data/tp_era5_19850101-20141231.nc","./data/mx2t_era5_19850101-20141231.nc","./data/mn2t_era5_19850101-20141231.nc")
...
file.template="var_daily_climpact.era5_historical_NA_1985-2014.nc"
