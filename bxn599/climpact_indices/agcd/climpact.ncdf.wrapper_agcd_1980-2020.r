...
infiles=c("./data/precip-total_AGCD-CSIRO_r005_19800101-20201231_daily.nc","./data/tmax_AGCD-CSIRO_r005_19800101-20201231_daily.nc","./data/tmin_AGCD-CSIRO_r005_19800101-20201231_daily.nc")
...
file.template="var_daily_climpact.agcd_historical_NA_1980-2020.nc"
