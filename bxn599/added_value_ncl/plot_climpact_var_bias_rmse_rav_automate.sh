...
fl='"./noresm2-mm_txx_annual_added_value_bias_rmse_awap_grid.nc"'
#fl='"./noresm2-mm_tasmin_annual_added_value_bias_rmse_awap_grid.nc"'


echo $prf
ncl plot_climpact_var_bias_rmse_rav_automate.ncl fl=$fl run_name=$run_name yyyy_start=$yyyy_start yyyy_end=$yyyy_end var=$var season=$season statistic=$statistic
