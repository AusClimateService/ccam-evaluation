...
ncl plot_var_monthly_seasonal_bias_rmse_no_agcd_vectors_automate.ncl varu=$varu varv=$varv varp=$varp yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info

#var='"va850"'
#info='"850hPa_meridional_wind"'
#ncl plot_var_monthly_seasonal_bias_rmse_no_agcd_automate.ncl var=$var yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info
#
#var='"ua500"'
