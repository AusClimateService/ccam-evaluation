...
ncl plot_climpact_difference_with_agcd_automate.ncl var=$var period=$period filen=$filen fileo=$fileo yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info
