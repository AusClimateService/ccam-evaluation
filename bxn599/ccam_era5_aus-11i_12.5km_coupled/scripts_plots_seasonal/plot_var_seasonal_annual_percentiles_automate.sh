...
var='"pr"'
info='"rainfall"'
ncl plot_var_seasonal_annual_percentiles_automate.ncl var=$var period=$period yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info
