...
ncl plot_var_monthly_seasonal_average_no_agcd_vectors_automate.ncl varu=$varu varv=$varv varp=$varp yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info
