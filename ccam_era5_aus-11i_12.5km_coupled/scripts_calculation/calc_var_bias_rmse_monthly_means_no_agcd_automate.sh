...
ncl calc_var_bias_rmse_monthly_means_no_agcd_automate.ncl run_name=$run_name var=$var yyyy_start=$yyyy_start yyyy_end=$yyyy_end ls_rcm=$ls_rcm ls_gdd=$ls_gdd rcm_var_name=$rcm_var_name gdd_var_name=$gdd_var_name
