...
ncl plot_climpact_var_seasonal_annual_bias_rmse_automate.ncl var=$var period=$period filen=$filen fileo=$fileo fileg=$fileg yrStrt=$yrStrt yrLast=$yrLast run_name=$run_name info=$info
